...
# game window section starts from here 
gamedisplays=pygame.display.set_mode((display_width,display_height))
pygame.display.set_caption("NFS7 - Design and developed by gaurav chauhan")
clock=pygame.time.Clock()
carimg=pygame.image.load('images/car1.jpg')
backgroundpic=pygame.image.load("images/download12.jpg")
yellow_strip=pygame.image.load("images/line.jpg")
...
# =====================================================================
# introduction loop section for game 
...
def intro_loop():
    ...
    while intro:
        ...
        TextSurf,TextRect=text_objects("NFS7",largetext)
        TextRect.center=(400,100)
        gamedisplays.blit(TextSurf,TextRect)
        button("START",150,520,100,50,green,bright_green,"play")
        button("QUIT",550,520,100,50,red,bright_red,"quit")
        button("INSTRUCTION",300,520,200,50,WHITE,bright_blue,"intro")
        pygame.display.update()
        clock.tick(50)
# ==========================================================================
# buttons used in game module 
...
# ==================================================================
# introduction shown on display written here 
...
def paused():
    ...
    while pause:
            ...
            gamedisplays.blit(TextSurf,TextRect)
            button("CONTINUE",150,450,150,50,WHITE,bright_green,"unpause")
            button("RESTART",350,450,150,50,blue,bright_blue,"play")
            button("MAIN MENU",550,450,200,50,green,bright_red,"menu")
            pygame.display.update()
            clock.tick(30)
# ==========================================================================
# unposed the game             
...
# =========================================================================
# background of the countdown section
...
def countdown_background():
    ...
    button("PAUSE",650,0,150,50,WHITE,bright_blue,"pause")

# ==================================================================
# if countdown is true the function countdown works and count the scores  
...
# ===============================================================
# obstacles function   for game  the cars come on the roads one by one 

def obstacle(obs_startx,obs_starty,obs):
    if obs==0:
        obs_pic=pygame.image.load("images/car.jpg")
    elif obs==1:
...
# ===========================================================================
# this function counts the socre of the passed cars
...
# ==============================================
# it handles the main backround of the game 
...
# ==============================================================
# main loop of the game start here 
