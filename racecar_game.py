# designd with the help of nayan mehta videos 
#love melody


# deesigned and developed by gaurav chauhan 
...
# the music is commmented for now
...
pygame.display.set_caption('Designed By Gaurav Chauhan')
carImg = pygame.image.load('racercar.jpg')
...
def game_intro():
    ...
    while intro:
        ...
        largeText = pygame.font.Font('freesansbold.ttf', 115)
        TextSurf, TextRect = text_objects("Version 1", largeText)
        TextRect.center = ((display_width / 2), (display_height / 2))
        gameDisplay.blit(TextSurf, TextRect)
